...
def course_layout_view(request, course, user):
    ...
    return render(request, 'course_layout.html', {'topics': topics, 'course': course, 'user': user})
...
def course_info(reqeust, course_id):
    ...
    return render(reqeust, 'course_info.html', {'course': course, 'html_content': html_content})
